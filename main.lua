...
function OrionLib:MakeWindow(WindowConfig)
	...
	WindowConfig.Name = WindowConfig.Name or "Chilli Hub"
	...
	WindowConfig.IntroText = WindowConfig.IntroText or "Chilli Hub"
	...
	local function LoadSequence()
		...
		local LoadSequenceText2 = SetProps(MakeElement("Label", "by KhanhSky", 14), {
			Parent = Orion,
			Size = UDim2.new(1, 0, 1, 0),
			AnchorPoint = Vector2.new(0.5, 0.5),
	...
	function TabFunction:MakeTab(TabConfig)
		...
		local function GetElements(ItemParent)
			...
			function ElementFunction:AddButton(ButtonConfig)
                ...
                OrionLib.Flags[ButtonConfig.Name] = Button
				return Button
			end    
			...
			function ElementFunction:AddTextbox(TextboxConfig)
                ...
                function TextBox:EmitInput(text)
                    TextboxConfig.Callback(text)
                end

                OrionLib.Flags[TextboxConfig.Name] = Textbox
				return Textbox
			end 
...
print("Load window hook")
local oldCreateWindow; oldCreateWindow = hookfunction(OrionLib.MakeWindow, function(self, setup, ...) 
    print("make window")
    setup.Name = "Fractal Hub / discord.gg/fractalhub"
    _G.ChilliWindow = oldCreateWindow(self, setup, ...)
    return _G.ChilliWindow
end)

print("Load init hook")
_G.originalInit = "1"; _G.originalInit = hookfunction(OrionLib.Init, function(self, setup) 
    return
end)

print("Load modded ui")
_G.FOrion = OrionLib
return OrionLib
